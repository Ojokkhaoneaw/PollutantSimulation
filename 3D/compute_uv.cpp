...
void compute_uv(double ***var_u, double ***var_v, double ***var_w, double ***var_F, double ***var_G, double ***var_H, double ***var_p_new, int nx, int ny, int nz, double dx, double dy, double dz, double dt) {
