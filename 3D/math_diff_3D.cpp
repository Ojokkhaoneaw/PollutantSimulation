...
double dp_dx_3D(double ***var_p, int i, int j, int k, double dx) {
...
double dp_dy_3D(double ***var_p, int i, int j, int k, double dy) {
  return (var_p[i][j+1][k]-var_p[i][j][k])/dy;
}

//---------------- z-axis ------------------------
double dw_dz_3D(double ***var_w, int i, int j, int k, double dz) {
...
double dp_dz_3D(double ***var_p, int i, int j, int k, double dz) {
  return (var_p[i][j][k+1]-var_p[i][j][k])/dz;
}


double dphi_dx_3D(double ***var_phi, int i, int j, int k, double dx){
  return (var_phi[i+1][j][k]-var_phi[i][j][k])/dx;  
}


double dphi_dy_3D(double ***var_phi, int i, int j, int k, double dy){
  return (var_phi[i][j+1][k]-var_phi[i][j][k])/dy;  
}


double dphi_dz_3D(double ***var_phi, int i, int j, int k, double dz){
...
double dwphi_dz_3D(double ***var_w, double ***var_phi, int i, int j, int k, double dz, double gamma) {
